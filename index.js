...
function resizeValidate(input, output) {
...
function jpgCompress(input, output) {
	return new Blue((resolve, reject) => {
...
function pngCompress(input, output) {
	var compressLevel = 5;
